...
!(function ($) {
    ...
    $(document).ready(function () {/* 
    var container_width = $(".partner .container").outerWidth();
    var body_width = $("body").outerWidth();
    var not_width = $(".notification").outerWidth();
    var col_width = container_width - not_width

    var gap = body_width - container_width - 40 ;
    $(".partner").find(".partner-width").css("width", col_width );
    console.log(container_width);
    console.log(body_width);
    console.log(gap); */


        $(".priorities .toggle-button").click(function () {
            $(this).parents(".priorities").toggleClass("open");
        });
    });
